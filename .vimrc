...
Plugin 'elvestar/vim-snippets'
" Django // TODO(zy): Need a good way to distinguish .py and .html file
" in djaogo project
...
Plugin 'sjl/gundo.vim' " (2015-03-23)
Plugin 'tpope/vim-fugitive' " (2015-03-23)

"" C/C++
Plugin 'vim-scripts/a.vim'
" Plugin 'bbchung/clighter' (Need libclang with its python binding)
...
let g:author_name="zy <elvestar@qq.com>"
...
if has("autocmd")
    ...
    autocmd FileType python setlocal shiftwidth=4 | setlocal softtabstop=4 | setlocal tabstop=4
